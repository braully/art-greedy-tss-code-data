...
//        graph = UtilGraph.loadGraphES("0-2,1-4,2-3,2-4,");
        graph = UtilGraph.loadBigDataset(
                new FileInputStream("/home/Braully Rocha da Silva/Workspace/tss/TSSGenetico/Instancias/Foursquare/nodes.csv"),
                new FileInputStream("/home/Braully Rocha da Silva/Workspace/tss/TSSGenetico/Instancias/Foursquare/edges.csv"));
